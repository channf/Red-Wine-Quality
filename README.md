...
6. Using PCA for dimensionality reduction
...
8. Advanced Modeling - Random Forest and KNN Classifier 
...
9. Compare Random Forest and KNN model and select the best model 
...
10. Cluster Analysis - K-means, DBSCAN, Hierarchical
...
* [Raw Data](http://archive.ics.uci.edu/ml/datasets/wine+quality)
